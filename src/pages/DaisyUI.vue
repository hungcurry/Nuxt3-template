<script setup>
import YwButton from '@/components/Button/YwButton.vue';
...
<template>
  <div>
    <div class="button-container my-10 flex justify-center">
    ...
    <div class="my-10 flex justify-center">
      <label class="swap swap-rotate">
        ...
        <svg
          v-if="isLight"
          class="sun h-10 w-10 fill-current"
        ...
        <svg
          v-else
          class="moon h-10 w-10 fill-current"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
        >
          <path
